...
function widget:GetInfo()
    return {
        name      = "Instant Dgun (patched)",
        desc      = "Aims when you press d-gun key down, fires when you release. VERSION 2.2: Patched in 'b' as a build key, now allows you to use b to cycle through potential buildings",
        author    = "Errrrrrr, Tomruler",
        date      = "May 23, 2023",
        version   = "2.2",
...
-- Enabled 'sc_b' as a build key, feel free to assign more quickbuilds here for default keybind users
--------------------------------------------------------------------------------------------
...
local isBuildKey = {
    [122]=true, [120]=true, [118]=true, [99]=true, [98]=true
}
